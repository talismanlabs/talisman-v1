...
| S09.02 | 9 | Add budget circuit breakers | Codex CLI | Claude Code | review_ready | Simulated daily/monthly cap pauses work. (adapters/sqlite/budget; pre-call hard-cap breaker; budget_events) |
