...
| S08.01 | 8 | Add structured review artifact format | Claude Code | Codex CLI | review_ready | Reviews save status, findings, and required fixes. (domain Finding + ReviewResult.findings + dict round-trip) |
