...
def test_claude_code_worker_satisfies_worker_contract(
    ...
    worker = ClaudeCodeWorker(runner=lambda args, cwd, timeout: CommandResult(0, "ran ok"))
...
def test_claude_code_worker_propagates_nonzero_exit(worker_request) -> None:
    ...
    worker = ClaudeCodeWorker(runner=lambda args, cwd, timeout: CommandResult(2, "boom"))
