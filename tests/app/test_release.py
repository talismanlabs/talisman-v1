...
def test_only_end_to_end_proven_criteria_are_pass() -> None:
    ...
    (automatic incident dump on catastrophic halt, S16.12), and AT-17 (durable lessons surfaced at
    intake, S16.13).
    """
...
def test_all_v1_waivers_are_hardened_to_pass() -> None:
    """v1 was accepted with five founder-approved waivers; v1.1-P1 hardened every one to PASS —
    AT-04 (S16.07), AT-12 (S16.08), AT-16 (S16.11), AT-19 (S16.12), AT-17 (S16.13) — so NO approved
    waivers remain."""
